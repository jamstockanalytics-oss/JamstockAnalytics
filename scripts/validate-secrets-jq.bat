...
REM Create JSON configuration
echo {
echo   "required_secrets": {
echo     "SUPABASE_HOST": {
echo       "description": "Supabase host URL",
echo       "pattern": "^https?://.+",
echo       "min_length": 10,
echo       "example": "https://your-project-ref.supabase.co"
echo     },
echo     "SUPABASE_PASSWORD": {
echo       "description": "Supabase database password",
echo       "min_length": 8,
echo       "example": "your-secure-password"
echo     },
echo     "LOCATION": {
echo       "description": "Deployment location",
echo       "pattern": "^[a-zA-Z0-9\\-_]+$",
echo       "min_length": 2,
echo       "example": "us-east-1"
echo     }
echo   },
echo   "optional_secrets": {
echo     "SUPABASE_URL": {
echo       "description": "Supabase project URL",
echo       "pattern": "^https://[a-zA-Z0-9\\-]+\\.supabase\\.co$",
echo       "min_length": 20,
echo       "example": "https://your-project-ref.supabase.co"
echo     },
echo     "DEEPSEEK_API_KEY": {
echo       "description": "DeepSeek API key for AI features",
echo       "pattern": "^sk-",
echo       "min_length": 20,
echo       "example": "sk-your-deepseek-api-key"
echo     }
echo   }
echo } > %TEMP%\secrets-config.json
