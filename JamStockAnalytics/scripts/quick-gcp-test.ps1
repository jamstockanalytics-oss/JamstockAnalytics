...
# Test 3: Test GitHub Actions workflow files
Write-Host "🔍 Test 3: Checking GitHub Actions workflow files..." -ForegroundColor Blue
$workflowFiles = @(
...
# Test 4: Test validation scripts
Write-Host "🔍 Test 4: Checking validation scripts..." -ForegroundColor Blue
$scriptFiles = @(
